...
# Read in data
data_Halpha = clean_flux(fits.open('./NGC1275_lowres_3_sinc_Halpha_Flux.fits')[0].data)
data_NII = clean_flux(fits.open('./NGC1275_lowres_3_sinc_NII6583_Flux.fits')[0].data)
